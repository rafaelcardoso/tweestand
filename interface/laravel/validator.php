...
class Validator {
	...
	/**
	 * Validate that a empty value
	 *
	 * @param  string  $attribute
	 * @param  mixed   $value
	 * @return bool
	 */
	protected function validate_empty($attribute, $value)
	{
		if (is_null($value))
		{
			return true;
	...
	/**
	 * Validate that an attribute contains only alphabetic characters, whitespaces.
	 *
	 * @param  string  $attribute
	 * @param  mixed   $value
	 * @return bool
