...
class UserInputValidation extends Validation_Service {
	...
	*/
	public function validate_new_user() {
		...
		$this->rules = array(
			...
			'username'   => array('required','unique:users','between:3,20','alpha_num'),
			'email'      => array('required','unique:users','email','between:10,60'),
	...
	*/
	...
	public function validate_resend_instructions() {
		...
		$this->rules = array(
			'email'  => array('required','exists:users','email','between:10,60')
		);
