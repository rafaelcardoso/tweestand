...
Autoloader::map(array(
	...
	'AcessAuth' 			=> path('app').'models/services/user/acessauth.php',
	'User' 					=> path('app').'models/entities/user.php',
	'TwitterAccount'		=> path('app').'models/entities/twitteraccount.php',
	'CurrentFollower' 		=> path('app').'models/entities/currentfollowers.php',
	'DailyUpdate'			=> path('app').'models/entities/dailyupdate.php',
	'Role'					=> path('app').'models/entities/role.php'
));
...
Auth::extend('acessauth', function() {
    return new AcessAuth();
});